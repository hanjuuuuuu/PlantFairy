...
const NewReccomend = ({ usernum, buttonValue }) => {
  ...
  const onNewRecommend = () => {
    // 페이지로 이동
    navigate("/newRecommend4", { state: state });
  };
  ...
  const onUserPlantPrint = () => {
    ...
    axios
      .post("http://localhost:8800/getbeforplant", {
  ...
  const onUserPlantPickPrint = () => {
    axios
      .post("http://localhost:8800/getbeforepick", {
        usernum: currentUser.user_num,
      })
      .then((response) => {
            ...
            <div className="Address">
              ...
              <label>
                <input
                  type="checkbox"
                  value="가격"
                  checked={checkedItems.includes("가격")}
              ...
              <label>
                <input
                  type="checkbox"
                  value="관리의 어려움"
                  checked={checkedItems.includes("관리의 어려움")}
                  onChange={handleCheckboxChange}
                />
                관리의 어려움
              </label>
              <label>
                <input
                  type="checkbox"
                  value="시각적 취향이 아님"
                  checked={checkedItems.includes("시각적 취향이 아님")}
                  onChange={handleCheckboxChange}
                />
                시각적 취향이 아님
              </label>
              <label>
                <input
                  type="checkbox"
                  value="알레르기 반응"
                  checked={checkedItems.includes("알레르기 반응")}
                  onChange={handleCheckboxChange}
                />
                알레르기 반응
              </label>
              <label>
                <input
                  type="checkbox"
                  value="냄새나 향기"
                  checked={checkedItems.includes("냄새나 향기")}
                  onChange={handleCheckboxChange}
                />
                냄새나 향기
              </label>
          ...
          <>
            ...
            <div className="Time">
              ...
              <p>
                ...
                {plantName}와 비슷한 식물을 추천받으시겠어요? 아니면 새로 추천을
                받으시겠어요?
              </p>
              <p>
                (새로운 추천은 기존에 했던 선택에 추가로 구체적인 질문을
                묻습니다!)
              </p>
              <br></br>
              <div>
      ...
      return (
        <>
          ...
          <div className="Experience">
            ...
            <div>
              {{ usernum } && plantName && (
                <p>{plantName}에 대한 추천이 마음에 들었나요?</p>
              )}
              <div>
                <br></br>
                <div>
